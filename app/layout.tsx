...
export const metadata: Metadata = {
  metadataBase: new URL("https://visualcraft.studio"), // TODO: replace with real domain
  title: {
    default: "VisualCraft — Premium Video Editing for Brands & Creators",
  ...
  openGraph: {
    title: "VisualCraft — Premium Video Editing Studio",
    description:
